...
const PlanetCard: React.FC<InPlanetCard> = ({
  englishName,
  mass,
  gravity,
  isFavorite,
  ...
  return (
    <TouchableOpacity onPress={onPress} style={styles.item}>
      {planetImages[englishName] && (
        <Image source={{uri: planetImages[englishName]}} style={styles.image} />
      )}
